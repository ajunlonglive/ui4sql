...
public abstract class FormDataWriter extends FormWriter {
	...
	public void writeTemplate(String templateName, String mode) throws services.ServicesException {
		...
		try {
			...
			String path = "http://" + sm.getServletContext().getInitParameter("Templates-path") + templateName;
			...
			//debug("getting buffered reader " + "http://" + sm.getServletContext().getInitParameter("Templates-path"));
			...
			debug("FormDataWritter:write template :: " + ioe.toString());
		}
